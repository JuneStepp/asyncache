...
class DictWrapperTest(unittest.TestCase, AsyncMixin):
    def cache(self):
        return dict()


class LFUTest(unittest.TestCase, AsyncMixin):
    def cache(self):
        return cachetools.LFUCache(10)


class LRUTest(unittest.TestCase, AsyncMixin):
    def cache(self):
        return cachetools.LRUCache(10)


class RRTest(unittest.TestCase, AsyncMixin):
    def cache(self):
        return cachetools.RRCache(10)


class TTLTest(unittest.TestCase, AsyncMixin):
    def cache(self):
